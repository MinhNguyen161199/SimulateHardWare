      ...
      if(count == 8){
        for (int i = 0 ; i < 5 ; i++){
          ...
          if(tag == t){
            ...
            Serial.print("TT PIN:");Serial.println(tt);
      ...
      if(count == 8)  {
        for (int i = 0 ; i < 5 ; i++){
          ...
          if(tag == t){
            ...
            Serial1.print("TT PIN:");Serial1.println(tt);
            lcd.setCursor(0, 0);lcd.print("ID:");
            lcd.setCursor(3, 0);lcd.print(id);
            lcd.setCursor(0, 1);lcd.print("Valid PIN");
      ...
      if(count == 8)  {
        for (int i = 0 ; i < 5 ; i++){
          ...
          if(tag == t){
            ...
            Serial2.print("TT PIN:");Serial2.println(tt);
            lcd.setCursor(0, 0);lcd.print("ID:");
            lcd.setCursor(3, 0);lcd.print(id);
            lcd.setCursor(0, 1);lcd.print("Valid PIN");
            // hiển thị thông tin khác 
      ...
      if(count == 8)  {
        for (int i = 0 ; i < 5 ; i++){
          ...
          if(tag == t){
            ...
            Serial3.print("TT PIN:");Serial3.println(tt);
